...
var queryString = require('querystring'), requestFormats = require('../lib/request-formats');
...
exports.createConnection = function(options) {
  ...
  return new AuthorizeNetCIMClient(options, connection, options.debug);
};

var AuthorizeNetCIMClient = function(options, client, debug) {
    var id = false, key = false, reqId = false, type = false;
  ...
  this.createAuthOnlyTransaction = function(params, cb) {
    ...
    sendAuthNetRequest('createCustomerProfileTransaction', params, cb);
  };
  ...
  this.createCaptureTransaction = function(params, cb) {
    params.transactionType = 'capture';
  ...
  this.createPriorAuthAndCaptureTransaction = function(params, cb) {
    params.transactionType = 'priorAuthCapture';
  ...
  this.validatePaymentProfileRequest = function(params, cb) {
    sendAuthNetRequest('validateCustomerPaymentProfile', params, cb);
  }
  ...
  var sendAuthNetRequest = function(method, params, cb) {
    ...
    var requestEmitter = request(method, requestBody);
  ...
  var parseAuthnetResponse = function(response) {
    ...
    parsedResponse.response_code = response.messages.message.code;
  ...
  var request = function(method, content) {
    var body = '';
    ...
    if(!errors) {
      client.sendServerRequest(body, function(err, response) {
        ...
        if(response.messages.resultCode == 'Error') {
          ...
          if(parsedResponse.response_code !== undefined) {
            if(parsedResponse.response_code == 'I00001' || parsedResponse.response_code == '1') {
